        ...
        <div>
            ...
            bg-white text-black'>
                ...
                <div className='nav-center block text-xl py-2 px-4 lg:flex lg:justify-end items-center'>
                    <div className={`${isOpen ? 'mx-4 text-lg  lg:w-3/5 lg:flex lg:items-center' : 'px mx-4 hidden text-lg lg:w-3/5 lg:flex lg:items-center'}`}>
                        <ul className='px-2 w-full lg:flex lg:items-center'>
